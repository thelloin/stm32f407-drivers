...
/**
* @brief  Configure the mode of a pin : input, output, alt or analog mode
* @param  *GPIOx : GPIO Port Base address
* @param  pin_no : GPIO pin number
* @param  mode   : mode to be configured
* @retval None
*/
void hal_gpio_configure_pin_mode(GPIO_TypeDef *GPIOx, uint16_t pin_no, uint16_t mode)
{
...
* @param  *GPIOx : GPIO Base Port address
