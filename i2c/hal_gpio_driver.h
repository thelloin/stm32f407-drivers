...
#define GPIO_PIN_OP_TYPE_OPEN_FRAIN                    ( (uint32_t) 0x01 )
...
/***************************************************************************/
/*                                                                         */
/*            2. Data Structures for GPIO pin Initialization               */
/*                                                                         */
/***************************************************************************/

/**
* @brief  GPIO pin configuration structure
*         This structure will be filled and pased to driver by the application to
...
typedef struct
{
	...
	uint32_t pull;             /* Specifies the Pull-up or Pull_Sown activation for the selected pins */
...
* @retval None
*/
void hal_gpio_write_to_pin(GPIO_TypeDef *GPIO, uint16_t pin_no, uint8_t val);
...
/**
* @brief  Clear hte sticky interrupt pending bit if set
* @param  pin_no : GPIO pin number
* @retval None
*/
