...
/**
  ...
  * @param  SPIx : Base address of the SPI
  * @param  ssm_enable : if 1, enable ssm
  * @param  None
  */
...
/**
  ...
  * @param  *SPIx : Base address of the SPI
  * @param  direction : if 1, direction will be single line bi-directional else,
...
/**
  ...
  * @param  hspi : pointer to a spi_handle_t structure that contains
                   configure information for SPI module
  * @retval None
  */
